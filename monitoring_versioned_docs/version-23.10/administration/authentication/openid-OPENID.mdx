...
If you turn on **Enable automatic management**, users that log in to i-Vertix IT Monitoring will be attached to the [contact groups](../../managing-users-contacts/contact-groups.md) you have defined.
...
If you turn off **Enable automatic management**, you have to manage manually relation between contact and [contact groups](../../managing-users-contacts/contact-groups.md).
