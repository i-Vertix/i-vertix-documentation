...
* **Geographic coordinates** defines geographical coordinates used by the MAP feature to position the resource on a map. Define "Latitude,Longitude", for example for Amsterdam coordinates set "52.37,4.89".
