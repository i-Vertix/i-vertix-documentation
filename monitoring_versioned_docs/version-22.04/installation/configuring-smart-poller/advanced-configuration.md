...
[Passive Monitoring](../../monitoring-resources/passive-monitoring/enable-snmp-traps.md).

Configuring the Centreontrapd process is the same as on the Central Manager.
