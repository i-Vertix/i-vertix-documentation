...
If you turn on **Enable automatic management**, users that log in to i-Vertix will be attached to the [contact groups](../../managing-users-contacts/contact-groups.md) you have defined.
