...
The i-Vertix Pollers run a scheduler responsible for planning and executing checks. 
To troubleshoot a Plugin, you must always:

* Copy/Paste the command from the i-Vertix Web UI to troubleshoot it from the CLI
...
In this situation, reach us with ann e-mail at [Support i-Vertix](mailto:support@i-vertix.com) or, even better, 
track an issue within the [i-Vertix Helpdesk portal](https://helpdesk.i-vertix.cloud/) 
...
To set up SNMPv3, i-Vertix is advising first to try to query your device by using the "snmpwalk" 
...
* An SNMP Agent or i-Vertix Host misconfiguration, like a wrong SNMP port, version, 
or community string
...
To check the storage attached to a device or system, i-Vertix Plugins use standard 
