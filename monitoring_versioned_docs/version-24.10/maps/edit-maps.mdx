...
Placing objects on maps is only available on graphical (normal) and geographical maps. If you are looking for a help on topology maps, see our documentation section on [creating topology maps](./managing-maps.mdx#create-a-new-topology-map).

:::

## Before you start

Make sure to have read all information about graphical and geographical maps in our documentation about [how to use and display maps](./visualize-maps.mdx#view-graphical-and-geographical-maps).

The next thing required for placing objects on maps is a map itself.
If you don't already have a map ready, have a look at our documentation on [how to create a graphical or geographical map](./managing-maps.mdx#create-a-new-graphical-or-geographical-map).

When you have your map created, open it from the [Map overview](./visualize-maps.mdx#map-overview).
...
Objects on geographical maps can be added automatically by other tools, such as the [Meraki Discovery](../monitoring-resources/discovery/meraki-discovery.mdx).
Positions of resources can be changed by other tools, such as the [Meraki Discovery](../monitoring-resources/discovery/meraki-discovery.mdx) and [Host Configuration Rules](../monitoring-resources/monitoring-hosts/updating-hosts-dynamically.mdx).
