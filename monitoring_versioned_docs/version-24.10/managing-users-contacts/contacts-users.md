...
* [Connect your i-Vertix IT Monitoring to an LDAP directory](../administration/authentication/ldap.mdx)
* [Connect your i-Vertix IT Monitoring to an IDP using SAML](../administration/authentication/saml.mdx)
* Make customizations:
  * Switch to dark mode
...
Please refer to the [Fail2Ban documentation](../installation/fail2ban.md) for further information.
