...
Additional to the below ports, the **[default monitoring port mappings](../installation/before-you-start/technical-information#tables-of-platform-flows-centralpoller) between *Central* and *Poller* are also used**.
