...
The API token was generated and presented during the [setup process of the i-Vertix BI server](./bi-setup#configure-bunsiness-intelligence-services-and-database).
