...
The Report Store is similar to our [Plugin Store](../../monitoring-resources/plugin-packs) which is used to install and update plugin packs.
...
To access the Report Store, make sure you already have [configured the i-Vertix Store credentials](../../quick-start-guide/plugin-store-configuration).
