...
- <ImageCounter num={7} /> the possibility to [reorder rules](./updating-hosts-dynamically.mdx#order-rulesets)
...
Using the [simulation conflict detail](./updating-hosts-dynamically.mdx?simulation=conflicts#test-your-rulesets) view during
