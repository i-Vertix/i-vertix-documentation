...
- <ImageCounter num={7} /> the possibility to [reorder rules](./updating-services-dynamically#order-rulesets)
...
Using the [simulation conflict detail](./updating-services-dynamically?simulation=conflicts#test-your-rulesets) view during
