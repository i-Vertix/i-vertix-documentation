...
To simply start a service discovery scan, select a host and a discovery template (which are installed by our [Plugin Store](../../monitoring-resources/plugin-packs.mdx)). You can pre-filter hosts by selecting a poller and/or a hostgroup.
