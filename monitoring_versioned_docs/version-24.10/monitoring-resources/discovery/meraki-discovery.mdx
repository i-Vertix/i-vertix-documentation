...
* Devices with coordinates can be placed on i-Vertix Maps, create a [geo map](../../maps/map-types.md) before running the discovery
...
the [Cisco Meraki Dashboard](../../reporting/dashboard-meraki.md).
