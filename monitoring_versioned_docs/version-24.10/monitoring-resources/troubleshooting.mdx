...
<TabItem value="snmp" label="SNMP walks">

Launch SNMP walks from any poller.

![SNMP walks](../assets/monitoring-resources/troubleshooter/snmp.png)
...
![SNMP walk list](../assets/monitoring-resources/troubleshooter/snmp_1.png)

Click the <ImageCounter num={1} disableMargin /> `+` button to start a new SNMP walk.
