...
Considered architecture: [***Basic***](../installation/before-you-start/architecture.mdx#basic)
...
When using the [***Remote DBMS***](../installation/before-you-start/architecture.mdx#dbms) architecture:
...
Considered architecture: [***Distributed***](../installation/before-you-start/architecture.mdx#distributed)
...
See also the [storage consumption list](../installation/before-you-start/prerequisites.mdx#storage-consumption) to understand how the storage on a *i-Vertix Central* server is consumed. 
