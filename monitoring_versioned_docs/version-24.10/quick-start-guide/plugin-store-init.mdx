...
To learn more about the *Upgrade* process, visit the detailed [*Plugin Store* Guide](../monitoring-resources/plugin-packs) which covers the whole *Plugin Store* ecosystem.
...
You can read more about plugin packs in the [What is a Plugin Pack](../monitoring-resources/plugin-packs#plugin-pack) chapter of the documentation.
