...
This step needs to be done after completing the [*Plugin Store Configuration*](./plugin-store-configuration.mdx).
...
In case you see an alert, stating that you don't have access to the resources of the *plugin store*, you might have not configured the [*plugin store credentials*](./plugin-store-configuration.mdx)
...
To learn more about the *Upgrade* process, visit the detailed [*Plugin Store* Guide](../monitoring-resources/plugin-packs.mdx) which covers the whole *Plugin Store* ecosystem.
...
You can read more about plugin packs in the [What is a Plugin Pack](../monitoring-resources/plugin-packs.mdx#plugin-pack) chapter of the documentation.
