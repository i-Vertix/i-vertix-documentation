...
This step requires the finished setup of the [*Central Management System*](#import-the-mangement-system).

:::

Log into the monitoring web interface using your admin account and navigate to <Breadcrumb curmbs={["Configuration", "Pollers"]} />.

Click the `Add` button to open the *Poller Wizard*.

TODO: IMPORT STUFF FROM GIOVANNI


---

Keep your SSH connections active, we will return shortly to the consoles of the newly created *Pollers* to link them to the *Central Management*.