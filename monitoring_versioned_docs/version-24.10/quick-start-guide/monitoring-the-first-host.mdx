...
Study our [Monitoring Principles](../monitoring-resources/monitoring-principles.md) and the [Deploy Monitoring Configuration](../monitoring-resources/export-configuration.mdx) 
...
- [a network topology discovery to onboard network devices](../monitoring-resources/discovery/nedi.mdx)
- [a network scan using nmap and snmp](../monitoring-resources/discovery/host-discovery.md)
- [vmware discovery to onboard whole vmware datacenters](../monitoring-resources/discovery/vmware-discovery.mdx) in combination with the [further virtual machine OS scan](../monitoring-resources/discovery/vmware-os-discovery.mdx)
- [meraki discovery to import your cisco meraki ecosystem](../monitoring-resources/discovery/meraki-discovery.mdx)
- [a easy-to-use service discovery](../monitoring-resources/discovery/service-discovery.mdx) to increase the monitoring quality of your monitored servers and devices
...
1. Make sure you have the following plugin pack installed:
    ...
    The process of installing plugin packs was part of [this previous chapter](./plugin-store-init.mdx) of the *Quick Start Guide* or is fully described in the [Plugin Packs Guide](../monitoring-resources/plugin-packs.mdx).
...
Please read [this quick guide on how to export the monitoring configuration for a poller](../monitoring-resources/export-configuration.mdx) 
