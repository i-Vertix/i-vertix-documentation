...
- [vmware discovery to onboard whole vmware datacenters](../monitoring-resources/discovery/vmware-discovery.mdx) in combination with the [further virtual machine OS scan](../monitoring-resources/discovery/vmware-os-discovery.md)
