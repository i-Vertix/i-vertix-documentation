...
- <ImageCounter num={2} /> Click on all `+` blue buttons to install all missing *Modules*

<!---
- <ImageCounter num={2} /> Click the `Install all` button to install all missing *Modules**
--->
