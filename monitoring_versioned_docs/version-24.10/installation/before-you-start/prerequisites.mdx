...
Considered architecture: [***Basic***](./architecture.mdx#basic)
...
When using the [***Remote DBMS***](./architecture.mdx#dbms) architecture:
...
Considered architecture: [***Distributed***](./architecture.mdx#distributed)
