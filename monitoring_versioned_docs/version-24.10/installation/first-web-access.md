...
Open your browser (see [Compatibility](./before-you-start/compatibility.md)) and enter the Central Manager IP Address previously configured (see [Network configuration](../installation/setup-central-poller/network-configuration.mdx)).
