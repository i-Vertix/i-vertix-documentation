...
1. Go to <Breadcrumb crumbs={["Configuration", "Pollers"]} />
...
A comprehensive description of all the communication happening between the Central and the Pollers can be found at [Table of network flows](../installation/before-you-start/technical-information.md).
