...
For example, \`www.itam-project.org\` is composed of labels \`www\`,
\`itam-project\` and \`org\`.
A computer name is composed of a label and the name of
the domain it belongs to, for example *www* name in domain
[https://www.itam-project.org](https://www.itam-project.org).
In i-Vertix ITAM, labels are compliant with section 2.1 of RFC 1123.

*FQDN*: A `FQDN (Fully qualified domain name)` is a fully qualified domain
name.
For example:

- [https://www.itam-project.org](https://www.itam-project.org)
- [https://forge.itam-project.org](https://forge.itam-project.org)
