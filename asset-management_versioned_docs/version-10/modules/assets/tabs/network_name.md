...
![general view of network name](../../../assets/modules/assets/images/network_name.png)
...
To add an IP address to a network name, click on the **+ Add** in front
of the IP address entry fields. To remove an IP address, simply delete
the contents of the IP field you wish to remove.
