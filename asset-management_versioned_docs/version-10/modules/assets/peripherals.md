...
Peripherals object refers to ancillary equipment or accessories
connected to a main system (computer, server, etc.). This includes
hardware elements required to operate or extend the capabilities of a
workstation or network.

![module assets - global view peripherals](../../assets/modules/assets/images/peripherals.png)
...
[templates with peripherals](../../modules/overview/templates.md).
