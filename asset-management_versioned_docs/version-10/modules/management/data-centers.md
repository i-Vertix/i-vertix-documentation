...
Data centers management in i-Vertix ITAM, more precisely management of servers
rooms and racks, allows to:

- Create an inventory of data centers, rooms and racks of the
  organization;
...
A server room is represented in i-Vertix ITAM by a schematic map. This map gives
the space available in the room to place racks.
...
The map is a grid defined by a number of lines and columns. One rack
consumes one square.

The background image can enhance room visualization, in particular if
this image has been generated by a dedicated tool.
...
This tab allow to display and modify the map of a server room by adding
directly on the map the racks composing the room.
