...
![A domain in i-Vertix ITAM](images/domains.png)
...
![List of attached records](images/recordslist-domains.png)
...
![Creation of a domain record](images/recordsadd-domains.png)
