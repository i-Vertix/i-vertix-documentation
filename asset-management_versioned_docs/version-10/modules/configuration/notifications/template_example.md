...
- **Subject**: `##ticket.action##: ##ticket.title##` *"\[i-Vertix ITAM
  \<ticket_number\>\]" will be automatically added to the email
  subject*
...
- **Email HTML body**: *this is the field that we will mainly modify in
  the next chapters*

## Case: New ticket

Let's start by adding some basic data. You can add more by using the
"\*\*Show list of available tags\*\*" button to display the available
tags.
...
into the recipient's language* - `##ticket.status##`: ticket status -
`##lang.ticket.url##`: text "URL" *automatically translated* -
`##ticket.url##`: ticket url - `##lang.ticket.description##`: text
"Ticket Description" *automatically translated* -
`##ticket.authors##`: ticket requesters *separated by ',' if there
is more than one* - `##ticket.creationdate##`: ticket creation date -
...
`##timelineitems.description##`: description text of the timeline
item - `##ENDFOREACHtimelineitems##`: end of the loop
...
> 2.  Click on the **format** drop-down list and select **Headings \>
>     Headings 1**

### Add a logo

> 1.  Without selecting any text, click on the place where you want to
>     put your image
> 2.  Click on **Insert image** button
> 3.  Browse to add your image
> 4.  If necessary, you can resize via **right-click** menu \>
>     **Image...**
...
1.  Without selecting any text, click on the place where you want to put
    your table

2.  Click on **Insert table** button

3.  The generated table has 2 columns and 2 rows, we only want one row,
    so delete one:

    1.  Right-click on the generated table
    2.  Clic on **Row** \> **Delete row**

4.  Select the previously added image, to drag and drop it into the left
    cell

5.  Select the text of the tags below, to drag and drop it into the
    right cell
...
7.  In **Advanced**, click on **Background color** field to select
    **Dark Blue**
...
As the background of the table is dark, we will write in white to be
more readable.

> 1.  Select the text in the table
> 2.  Click on the **Text color** drop-down list and select the color
>     **White**
...
1.  Add 2 test tags: `##IFticket.storestatus=4##`
...
Let's take the case where we have users who only understand one
language (English, French or Spanish). And we want to add a text under
the URL that everyone can understand:

- If you wish to add further information, click on the previous links,
  or reply directly to this e-mail. *English*
- Si vous souhaitez ajouter des informations supplémentaires, cliquez
  sur les liens précédents, ou répondez directement à cet e-mail.
  *French*
- Si desea añadir más información, haga clic en los enlaces anteriores,
  o responda directamente a este correo electrónico. *Spanish*
...
5.  Go back to the template header by clicking on the **Notification
    templates** value at the top
6.  In **Template translations** tab click on **Add a new translation**
    button
...
into HTML code which you can edit via **right-click** \> **Source
code**. So if you are familiar with HTML, you can edit the code
directly. Depending on the case and your skills, this is sometimes
easier.
  ...
  <tr>
   <td class="logo">
    <img src="data:image/png;base64,"
      alt="i-Vertix ITAM" width="100" height="55" /></td>
   <td class="title">
